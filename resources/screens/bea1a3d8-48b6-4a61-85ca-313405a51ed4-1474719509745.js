jQuery("#simulation")
  .on("click", ".s-bea1a3d8-48b6-4a61-85ca-313405a51ed4 .click", function(event, data) {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/bea1a3d8-48b6-4a61-85ca-313405a51ed4",
                    "transition": "fade"
                  },
                  "exectype": "serial",
                  "delay": 0
  ...
  .on("drag", ".s-bea1a3d8-48b6-4a61-85ca-313405a51ed4 .drag", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
  ...
  .on("dragend", ".s-bea1a3d8-48b6-4a61-85ca-313405a51ed4 .drag", function(event, data) {
